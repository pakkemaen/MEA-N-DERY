...
window.saveCellarTemp = saveCellarTemp;
window.openAgingModal = openAgingModal;
window.saveAgingUpdate = saveAgingUpdate;
window.consumeBottle = consumeBottle;
window.deleteCellarItem = deleteCellarItem;
